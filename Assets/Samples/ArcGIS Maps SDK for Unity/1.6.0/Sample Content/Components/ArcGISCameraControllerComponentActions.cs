...
//     version 1.8.1
//     from Assets/Samples/ArcGIS Maps SDK for Unity/1.6.0/Sample Content/Components/ArcGISCameraControllerComponentActions.inputactions
//
...
namespace Esri.ArcGISMapsSDK.Samples.Components
{
    ...
    ""controlSchemes"": []
        ...
        {
            Debug.Assert(!m_Move.enabled, "This will cause a leak and performance issues, ArcGISCameraControllerComponentActions.Move.Disable() has not been called.");
        }
